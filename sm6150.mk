...
AUDIO_POLICY_CONFIGURATION_FILE := $(LOCAL_PATH)/configs/audio/audio_policy_configuration.xml
endif
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/display/dsi_k6_38_0c_0a_fhd_dsc_video_display_mi.xml:$(TARGET_COPY_OUT_VENDOR)/etc/dsi_k6_38_0c_0a_fhd_dsc_video_display_mi.xml \
    ...
    $(LOCAL_PATH)/configs/display/vendor_etc_hdr_config.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/vendor_etc_hdr_config.cfg \
    $(LOCAL_PATH)/configs/display/vendor_etc_sdr_config.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/vendor_etc_sdr_config.cfg
...
# Miui Camera
$(call inherit-product-if-exists, vendor/miuicamera/anx.mk
...
# VNDK
PRODUCT_TARGET_VNDK_VERSION := 28 29 30
